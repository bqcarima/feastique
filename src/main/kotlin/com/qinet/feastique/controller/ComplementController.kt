...
class ComplementController(
    ...
    fun addOrUpdateComplement(
        ...
        return complementService.addOrUpdateComplement(complementDto, vendorDetails).toResponse()
    }
    ...
    fun deleteComplement(
        ...
        complementService.deleteComplement(id, vendorId, vendorDetails)
    }
    ...
    fun getAllComplements(
        @PathVariable vendorId: Long,
        @AuthenticationPrincipal vendorDetails: UserSecurity
    ) : List<ComplementResponse> {
        return complementService.getAllComplements(vendorId, vendorDetails).map { it.toResponse() }
    }
}